...
An end-to-end toolkit for running molecular dynamics simulations and analyzing the resulting trajectories. It pairs an OpenMM-based simulation engine with a comprehensive suite of trajectory analyses, producing publication-quality figures through a unified plotting framework.
